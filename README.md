...
More filters such as the unscented Kalman filter will be added in the future when time allows. 
In the meantime, contributions are welcome (please refer to [CONTRIBUTING.md](CONTRIBUTING.md)).
